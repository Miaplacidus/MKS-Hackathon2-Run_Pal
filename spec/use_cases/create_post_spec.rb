...
describe RunPal::CreatePost do
  ...
  it 'creates a new post' do
    ...
    result = subject.run({latitude: 30.25, longitude: -97.75, creator_id: user.id, max_runners: 10, time: Time.now, pace: 3, notes: "Fun!", min_amt: 12.50, age_pref: 3, gender_pref: 0})
    puts result.error
