...
describe RunPal::FilterPostsByPace do
  ...
  it 'filters posts by pace' do
    ...
    post3 = RunPal.db.create_post({creator_id: user.id, time: Time.now, location:[66, 77], pace: 3, notes:"Will be a fairly relaxed jog.", complete:true, min_amt:12.00, age_pref: 3, gender_pref: 1, committer_ids: [user.id]})
