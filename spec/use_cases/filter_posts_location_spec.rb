...
describe RunPal::FilterPostsByLocation do
  ...
  it 'filters posts by location' do
    ...
    post3 = RunPal.db.create_post({creator_id: user.id, time: Time.now, latitude: 66, longitude: 77, pace: 7, notes:"Will be a fairly relaxed jog.", complete:true, min_amt:12.00, age_pref: 3, gender_pref: 1})
