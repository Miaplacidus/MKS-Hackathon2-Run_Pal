...
describe RunPal::CreateChallenge do
  ...
  it 'creates a new challenge' do
    ...
    post = RunPal.db.create_post({location: [30.25, -97.75], creator_id: user1.id, max_runners: 10, time: Time.now, pace: 3, notes: "Fun!", min_amt: 12.50, age_pref: 3, gender_pref: 0})
